...
const uint8_t GLYPH_47[] = { 5, 2, 2, 4, 4, 8, 8, 16, 16, 0 }; // /
...
const uint8_t GLYPH_58[] = { 3, 0, 0, 6, 6, 0, 6, 6, 0, 0 }; // :
const uint8_t GLYPH_59[] = { 3, 0, 0, 6, 6, 0, 6, 2, 2, 4 }; // ;
...
const uint8_t GLYPH_97[] = { 5, 0, 0, 0, 28, 2, 14, 18, 14, 0 }; // a
const uint8_t GLYPH_98[] = { 5, 0, 16, 16, 16, 28, 18, 18, 28, 0 }; // b
const uint8_t GLYPH_99[] = { 5, 0, 0, 0, 0, 14, 16, 16, 14, 0 }; // c
const uint8_t GLYPH_100[] = { 6, 0, 0, 2, 2, 14, 18, 18, 14, 0 }; // d
const uint8_t GLYPH_101[] = { 5, 0, 0, 0, 28, 18, 28, 16, 14, 0 }; // e
const uint8_t GLYPH_102[] = { 4, 0, 0, 4, 10, 8, 12, 8, 8, 0 }; // f
const uint8_t GLYPH_103[] = { 5, 0, 0, 0, 12, 18, 14, 2, 18, 14 }; // g
const uint8_t GLYPH_104[] = { 5, 0, 0, 16, 16, 16, 28, 18, 18, 0 }; // h
const uint8_t GLYPH_105[] = { 3, 0, 0, 0, 6, 0, 4, 4, 6, 0 }; // i
const uint8_t GLYPH_106[] = { 4, 0, 2, 0, 2, 2, 10, 10, 6, 0 }; // j
const uint8_t GLYPH_107[] = { 4, 0, 0, 8, 8, 8, 10, 12, 10, 0 }; // k
const uint8_t GLYPH_108[] = { 3, 0, 0, 4, 4, 4, 4, 4, 6, 0 }; // l
const uint8_t GLYPH_109[] = { 6, 0, 0, 0, 0, 26, 21, 21, 21, 0 }; // m
const uint8_t GLYPH_110[] = { 4, 0, 0, 0, 0, 12, 10, 10, 10, 0 }; // n
const uint8_t GLYPH_111[] = { 4, 0, 0, 0, 4, 10, 10, 10, 4, 0 }; // o
const uint8_t GLYPH_112[] = { 4, 0, 0, 0, 14, 10, 10, 12, 8, 8 }; // p
const uint8_t GLYPH_113[] = { 4, 0, 0, 0, 14, 10, 10, 6, 2, 2 }; // q
const uint8_t GLYPH_114[] = { 4, 0, 0, 0, 0, 14, 8, 8, 8, 0 }; // r
const uint8_t GLYPH_115[] = { 4, 0, 0, 0, 4, 8, 4, 2, 12, 0 }; // s
const uint8_t GLYPH_116[] = { 4, 0, 0, 4, 14, 4, 4, 4, 6, 0 }; // t
const uint8_t GLYPH_117[] = { 5, 0, 0, 0, 0, 0, 18, 18, 14, 0 }; // u
const uint8_t GLYPH_118[] = { 5, 0, 0, 0, 0, 0, 18, 10, 6, 0 }; // v
const uint8_t GLYPH_119[] = { 6, 0, 0, 0, 0, 0, 21, 21, 10, 0 }; // w
const uint8_t GLYPH_120[] = { 4, 0, 0, 0, 0, 10, 4, 4, 10, 0 }; // x
const uint8_t GLYPH_121[] = { 5, 0, 0, 0, 0, 10, 14, 2, 10, 6 }; // y
const uint8_t GLYPH_122[] = { 5, 0, 0, 0, 0, 30, 2, 4, 30, 0 }; // z
