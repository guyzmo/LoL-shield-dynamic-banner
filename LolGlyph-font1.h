...
const uint8_t GLYPH_0[] = { 6, 63, 63, 63, 63, 63, 63, 63, 63, 63 }; // FULL char

const uint8_t GLYPH_32[] = { 6, 0, 0, 0, 0, 0, 0, 0, 0, 0 }; //' '
const uint8_t GLYPH_33[] = { 6, 0, 12, 12, 12, 12, 4, 0, 12, 0 }; // !
const uint8_t GLYPH_39[] = { 6, 0, 12, 4, 8, 0, 0, 0, 0, 0 }; // '
const uint8_t GLYPH_44[] = { 6, 0, 0, 0, 0, 0, 0, 12, 12, 4 }; // ,
const uint8_t GLYPH_46[] = { 6, 0, 0, 0, 0, 0, 0, 12, 12, 0 }; // .
const uint8_t GLYPH_47[] = { 6, 2, 2, 4, 4, 8, 8, 16, 16, 0 }; // /
const uint8_t GLYPH_48[] = { 6, 0, 12, 18, 22, 26, 18, 18, 12, 0 }; // 0
const uint8_t GLYPH_49[] = { 6, 0, 4, 12, 4, 4, 4, 4, 14, 0 }; // 1
...
const uint8_t GLYPH_54[] = { 6, 0, 12, 18, 16, 20, 26, 18, 12, 0 }; // 6
...
const uint8_t GLYPH_58[] = { 6, 0, 0, 8, 12, 0, 8, 12, 0, 0 }; // :
const uint8_t GLYPH_59[] = { 6, 0, 0, 12, 12, 0, 12, 12, 4, 8 }; // ;
const uint8_t GLYPH_63[] = { 6, 0, 12, 18, 6, 4, 4, 0, 4, 0 }; // ?
...
const uint8_t GLYPH_73[] = { 6, 0, 14, 4, 4, 4, 4, 4, 14, 0 }; // I
...
const uint8_t GLYPH_97[] = { 6, 0, 0, 0, 12, 2, 14, 18, 14, 0 }; // a
const uint8_t GLYPH_98[] = { 6, 0, 0, 16, 16, 16, 28, 18, 28, 0 }; // b
const uint8_t GLYPH_99[] = { 6, 0, 0, 0, 0, 0, 14, 16, 14, 0 }; // c
const uint8_t GLYPH_100[] = { 6, 0, 0, 2, 2, 2, 14, 18, 14, 0 }; // d
const uint8_t GLYPH_101[] = { 6, 0, 0, 0, 28, 18, 28, 16, 14, 0 }; // e
const uint8_t GLYPH_102[] = { 6, 0, 0, 4, 10, 8, 12, 8, 8, 0 }; // f
const uint8_t GLYPH_103[] = { 6, 0, 0, 12, 18, 14, 2, 18, 14, 0 }; // g
const uint8_t GLYPH_104[] = { 6, 0, 0, 8, 8, 8, 12, 10, 10, 0 }; // h
const uint8_t GLYPH_105[] = { 6, 0, 0, 0, 6, 0, 4, 4, 6, 0 }; // i
const uint8_t GLYPH_106[] = { 6, 0, 2, 0, 2, 2, 10, 10, 6, 0 }; // j
const uint8_t GLYPH_107[] = { 6, 0, 0, 8, 8, 8, 10, 12, 10, 0 }; // k
const uint8_t GLYPH_108[] = { 6, 0, 0, 4, 4, 4, 4, 4, 6, 0 }; // l
const uint8_t GLYPH_109[] = { 6, 0, 0, 0, 0, 26, 21, 21, 21, 0 }; // m
const uint8_t GLYPH_110[] = { 6, 0, 0, 0, 0, 12, 10, 10, 10, 0 }; // n
const uint8_t GLYPH_111[] = { 6, 0, 0, 0, 0, 4, 10, 10, 4, 0 }; // o
const uint8_t GLYPH_112[] = { 6, 0, 0, 0, 0, 14, 10, 12, 8, 8 }; // p
const uint8_t GLYPH_113[] = { 6, 0, 0, 0, 0, 14, 10, 6, 2, 2 }; // q
const uint8_t GLYPH_114[] = { 6, 0, 0, 0, 0, 14, 8, 8, 8, 0 }; // r
const uint8_t GLYPH_115[] = { 6, 0, 0, 0, 4, 8, 4, 2, 12, 0 }; // s
const uint8_t GLYPH_116[] = { 6, 0, 0, 4, 14, 4, 4, 4, 6, 0 }; // t
...
const uint8_t GLYPH_120[] = { 6, 0, 0, 0, 0, 10, 4, 4, 10, 0 }; // x
const uint8_t GLYPH_121[] = { 6, 0, 0, 0, 0, 10, 14, 2, 10, 6 }; // y
